...
from spyglass.shijiegu.Analysis_SGU import TrialChoice,DecodeIngredients,ChangeofMind,get_linearization_map,ChangeofMindRemoteTheta
...
def parse_remote_master(animal,list_of_days,classifier_param_name,encoding_set,params):
    ...
    all_info_animal, info_animal, time_intervals_animal, arm_identities_animal = find_remote_theta_animal(
        animal,list_of_days,classifier_param_name,encoding_set,fill_spyglass = True,**params)
...
def find_remote_theta_animal(animal,list_of_days,classifier_param_name,encoding_set,
                             ...
                             speed_threshold = 4,
                             max_flag = False,fill_spyglass = False):
    """
        ...
        for ind in range(len(session_interval)):
            ...
            for event_index in event_indices_session:
                ...
                replayed_arm_identity) = find_remote_theta_interval(
                    ...
                    max_flag,use_home,use_outer,use_center)
...
def find_remote_theta_interval(triggered_position,triggered_position_abs,triggered_trial_info,
                                ...
                                minimum_duration = 0.02): # in seconds
    """
